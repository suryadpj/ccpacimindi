                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $find->CustomerName }}</a>
                                    <a href="#">
                            ...
                            <div class="d-flex flex-column flex-grow-1 pe-8">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                        ...
                                        <!--end::Svg Icon-->
                                            <div class="fs-2 fw-bold">{{ $find->Dummy }}</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                        ...
                                        <!--end::Svg Icon-->
                                            <div class="fs-2 fw-bold">{{ $find->CustomerType }}</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                    ...
                    <div class="card-body pt-0 pb-1">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle gs-0 gy-4 table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ $find->SalesDate }}</td>
                                        <td>{{ $find->DeliveryDate }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $find->OperationDescription }}</td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-muted bg-light">KILOMETER</td>
                                        <td>{{ $find->Kilometer }}</td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-muted bg-light">KELUHAN</td>
                                        <td>TARIKAN BERAT</td>
                                    </tr>
                                </tbody>
                            </table>
