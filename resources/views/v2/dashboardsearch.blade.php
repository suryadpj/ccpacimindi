...
@if (session()->has('message'))
    <div
        ...
        <span class="ltr:pr-2 rtl:pl-2"><strong class="ltr:mr-1 rtl:ml-1">Data berhasil di update</strong>
            silahkan periksa kembali</span>
                                    ...
                                    @if ($find->contact_person)
                                        <tr>
                                            ...
                                            <td class="justify-around flex">
                                                ...
                                                &nbsp;
                                                <a href="https://wa.me/62{{ $find->contact_person }}"
                                                    target="_blank">
                                ...
                                <table class="table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="drink" placeholder="Some Text..."
                                                    class="form-input" value="{{ $voc->minuman ?? '-' }}" required />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="food" placeholder="Some Text..."
                                                    class="form-input" value="{{ $voc->makanan ?? '-' }}" required />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="interest" placeholder="Some Text..."
                                                    class="form-input" value="{{ $voc->interest ?? '-' }}"
                                                    required /></td>
